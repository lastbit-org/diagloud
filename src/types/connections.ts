...
export const EDGE_ENDPOINTS = {
  ...
  "vm-cloudlogging": { from: "vm", to: "cloudlogging" },
  ...
  "knowledgecatalog-storage": { from: "knowledgecatalog", to: "storage" },
  "knowledgecatalog-featurestore": { from: "knowledgecatalog", to: "featurestore" },
  "usergroup-iam": { from: "usergroup", to: "iam" },
  "usergroup-project": { from: "usergroup", to: "project" },
  "usergroup-vm": { from: "usergroup", to: "vm" },
  "usergroup-run": { from: "usergroup", to: "run" },
  "usergroup-gke": { from: "usergroup", to: "gke" },
  "pcuser-usergroup": { from: "pcuser", to: "usergroup" },
