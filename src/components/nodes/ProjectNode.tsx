...
export function ProjectNode({ id, data, selected }: NodeProps) {
  const { label, issueCount } = (data ?? {}) as ProjectNodeData;
  const displayName = label.trim() || "Projeto";
  ...
  return (
    ...
    >
      ...
      <img
        ...
        src={GCP_RESOURCE_ICONS.project}
        alt=""
        width={32}
        height={32}
        draggable={false}
